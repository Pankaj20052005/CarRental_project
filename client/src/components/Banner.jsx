...
const Banner = () => {
  return (
    <div className='flex flex_col md:flex-row md:items-start items-center
  ...
  [#A9CFFF] max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>
    ...
    <div className='text-white'>
        ...
        <p className='max-w-130'>We tale care of insurance, driver verification and secure payments - so you can earn passive income, stress-free.</p>
